                                                    ...
                                                    {newUserRequests.map(request => (
                                                        <tr key={request.id}>
                                                            ...
                                                            <td className="p-2 text-left">
                                                                ...
                                                                <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-2 border border-green-500 rounded" onClick={() => handleUserAction('accept', request.id)}>Accept</button>
                                                                <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-1 px-2 border border-orange-500 rounded" onClick={() => handleUserAction('decline', request.id)}>Decline</button>
                                                            </td>
                                                        </tr>
                                                    ))}
                                                </tbody>
