...
import com.example.FEC_Server.Service.UserService;
import com.example.FEC_Server.domain.user.UserRole;
import com.example.FEC_Server.jwt.JwtTokenFilter;
...
public class SecurityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .antMatchers("/latestEnvironmentData").authenticated()
                .antMatchers("/getPlantEnvironmentData").authenticated()
                .antMatchers("/getTodoData").authenticated()
                .antMatchers("/addTodoData").authenticated()
                .antMatchers("/getAvgData").authenticated()
                .antMatchers("/getWeather").authenticated()
